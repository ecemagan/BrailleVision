...
create table if not exists public.profiles (
  ...
  preferences jsonb not null default '{"dashboardDensity":"comfortable","documentView":"library","themeAccent":"lilac"}'::jsonb,
...
alter table public.profiles
  ...
  add column if not exists preferences jsonb not null default '{"dashboardDensity":"comfortable","documentView":"library","themeAccent":"lilac"}'::jsonb,
...
set
  ...
  preferences = coalesce(preferences, '{"dashboardDensity":"comfortable","documentView":"library","themeAccent":"lilac"}'::jsonb)
where email is null
